...
Completion time: 2020-09-21T10:56:15.2458260-05:00
...
insert into #temp (plane, yr) select 'Blériot 155','1925'
...
if object_id('tempdb..#temp') is not null drop table #temp
create table #temp (plane varchar(255), yr varchar(4))
insert into #temp (plane, yr) select 'Caudron C.280 Phalène','1932'
...
insert into #temp (plane, yr) select 'Blériot 115','1923'
